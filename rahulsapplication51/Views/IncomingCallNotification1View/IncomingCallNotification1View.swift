            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack {
                            HStack {
                                TextField(StringConstants.k_Lbl_open_chat, text: $incomingCallNotification1ViewModel.openchatText)
                            ...
                            Button(action: {}, label: {
                                Text(StringConstants.k_Msg_i_ll_call_you_l)
                                    .font(Font.system(size: getRelativeHeight(size: 13.0)))
                                    .foregroundColor(ColorConstants.Gray900)
                            ...
                            Button(action: {}, label: {
                                Text(StringConstants.k_Msg_can_t_talk_now)
                                    .font(Font.system(size: getRelativeHeight(size: 13.0)))
                                    .foregroundColor(ColorConstants.Gray900)
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Lbl_okay, text: $incomingCallNotification1ViewModel.okayText)
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Msg_i_will_vote_for, text: $incomingCallNotification1ViewModel.iwillvoteforText)
                                                .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                .foregroundColor(ColorConstants.Bluegray400)
                                                .padding()
                                        }
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Msg_will_it_ever_ha, text: $incomingCallNotification1ViewModel.williteverhaText)
                                                .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                .foregroundColor(ColorConstants.Bluegray400)
                                                .padding()
                                        }
