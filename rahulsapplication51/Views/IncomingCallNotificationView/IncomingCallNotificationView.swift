                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Lbl_okay, text: $incomingCallNotificationViewModel.okayText)
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Msg_i_will_vote_for, text: $incomingCallNotificationViewModel.iwillvoteforText)
                                                .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                .foregroundColor(ColorConstants.Bluegray400)
                                                .padding()
                                        }
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    VStack {
                                        HStack(spacing: 0) {
                                            TextField(StringConstants.k_Msg_will_it_ever_ha, text: $incomingCallNotificationViewModel.williteverhaText)
                                                .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                .foregroundColor(ColorConstants.Bluegray400)
                                                .padding()
                                        }
